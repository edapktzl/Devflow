...
- `npm.cmd test`: **48/48 başarılı**. Gerçek Node HTTP sunucusu, bellek içi SQLite ve yeniden başlatma testlerinde geçici SQLite dosyası kullanılır; harici provider yanıtları test fixture'larıdır.
